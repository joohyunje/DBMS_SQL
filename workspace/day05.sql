...
ALTER TABLE TBL_CAR DROP CONSTRAINT SYS_C007010;
...
-- 컬럼의 자료형 수정
ALTER TABLE TBL_ANIMAL MODIFY(ANIMAL_SERIAL_NUMBER VARCHAR2(1000));

-- 동물 테이블 삭제
DROP TABLE TBL_ANIMAL;
SELECT * FROM TBL_ANIMAL;
--==========================================================================
-- PK 의 특징과 FK 부여 방법 및 특징
...
INSERT INTO TBL_PRODUCT
VALUES(2, '팜레스트', 22000); -- PK 가 중복이라서 에러!

INSERT INTO TBL_PRODUCT
VALUES(3, '팜레스트', NULL); -- NULL 도 값으로 사용할 수 있다.(값이 없음을 나타내는 값)

INSERT INTO TBL_PRODUCT
VALUES(NULL, '두루마리 휴지', 25000); -- PK 는 NULL 을 넣을 수 없다.
...
INSERT INTO TBL_STUDENT
VALUES(4, '강감찬', 22, 4); -- FK인 SCHOOL_NUMBER 가 존재하지 않는 값을 저장.
...
CREATE TABLE TBL_STUDENT(
	...
	STUDENT_ID VARCHAR2(500) CONSTRAINT UK_STUDENT UNIQUE, -- KEY 를 붙이지 않음
	STUDENT_NAME VARCHAR2(500),
